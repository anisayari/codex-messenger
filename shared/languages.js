...
const appCopy = {
  ...
  en: {
    ...
    chat: { conversation: "Conversation", contactInfo: "Contact info", renameSession: "Rename session...", openProject: "Open project", sessionPrefix: "Session", configuration: "Codex configuration...", model: "Model", reasoning: "Reasoning", execution: "Execution", sandbox: "Authorization zone", confirmation: "Confirmation", askContext: "Ask Codex for context", myProfile: "My profile", changePicture: "Change my picture...", defaultPicture: "Default picture", typing: "is typing...", thinking: "Thinking...", send: "Send", search: "Search", stop: "Stop" },
    toolbar: { invite: "Invite", files: "Send Files", video: "Video", voice: "Voice", stop: "Stop", activities: "Activities", games: "Games" }
  },
  es: {
    ...
    updates: { aboutTitle: "Acerca de Codex Messenger", developedBy: "Desarrollado por Anis AYARI y Codex.", productDescription: "Cliente Electron local inspirado en MSN Messenger 7 y conectado a codex app-server.", productFront: "Front Codex Messenger", productServer: "Codex app-server", currentVersion: "Versión actual", localVersion: "Versión local", latestVersion: "Última versión", updateAutomatically: "Actualizar automáticamente", openReleases: "Abrir releases", updating: "Actualizando...", readyToInstall: "Descargado, listo para instalar", restartInstall: "Reiniciar e instalar", never: "nunca", checkedAt: "Última verificación: {checkedAt}.", privacyNote: "Codex Messenger no almacena conversaciones Codex: la aplicación solo es un cliente local.", check: "Buscar actualización", checking: "Verificando...", restart: "Reiniciar", download: "Descarga", installing: "Instalando...", verifyingInstall: "Verificando instalación...", restarting: "Reiniciando...", ready: "Listo.", progressInProgress: "Actualización en curso...", unknown: "desconocida", notChecked: "No verificado", updateAvailableLine: "Actualización disponible: {version}", checkIncomplete: "Verificación incompleta: {error}", upToDate: "Actualizado" },
    ...
    chat: { conversation: "Conversación", contactInfo: "Información del contacto", renameSession: "Renombrar sesión...", openProject: "Abrir proyecto", sessionPrefix: "Sesión", configuration: "Configuración Codex...", model: "Modelo", reasoning: "Razonamiento", execution: "Ejecución", sandbox: "Zona de autorización", confirmation: "Confirmación", askContext: "Pedir contexto a Codex", myProfile: "Mi perfil", changePicture: "Cambiar mi imagen...", defaultPicture: "Imagen predeterminada", typing: "está escribiendo...", thinking: "Pensando...", send: "Enviar", search: "Buscar", stop: "Detener" },
  ...
  ja: {
    ...
    updates: { aboutTitle: "Codex Messenger について", developedBy: "Anis AYARI と Codex が開発しました。", productDescription: "MSN Messenger 7 に着想を得た、codex app-server 接続のローカル Electron クライアントです。", productFront: "Codex Messenger フロント", productServer: "Codex app-server", currentVersion: "現在のバージョン", localVersion: "ローカルバージョン", latestVersion: "最新バージョン", updateAutomatically: "自動更新", openReleases: "リリースを開く", updating: "更新中...", readyToInstall: "ダウンロード済み、インストール準備完了", restartInstall: "再起動してインストール", never: "未確認", checkedAt: "最終確認: {checkedAt}。", privacyNote: "Codex Messenger は Codex の会話を保存しません。このアプリはローカルクライアントです。", check: "更新を確認", checking: "確認中...", restart: "再起動", download: "ダウンロード", installing: "インストール中...", verifyingInstall: "インストールを確認中...", restarting: "再起動中...", ready: "準備完了。", progressInProgress: "更新中...", unknown: "不明", notChecked: "未確認", updateAvailableLine: "更新があります: {version}", checkIncomplete: "確認未完了: {error}", upToDate: "最新" },
    ...
    chat: { conversation: "会話", contactInfo: "連絡先情報", renameSession: "セッション名を変更...", openProject: "プロジェクトを開く", sessionPrefix: "セッション", configuration: "Codex 設定...", model: "モデル", reasoning: "推論", execution: "実行", sandbox: "認可ゾーン", confirmation: "確認", askContext: "Codex にコンテキストを依頼", myProfile: "自分のプロフィール", changePicture: "画像を変更...", defaultPicture: "既定の画像", typing: "が入力中...", thinking: "Thinking...", send: "送信", search: "検索", stop: "停止" },
  ...
  ar: {
    ...
    chat: { conversation: "محادثة", contactInfo: "معلومات جهة الاتصال", renameSession: "إعادة تسمية الجلسة...", openProject: "فتح المشروع", sessionPrefix: "الجلسة", configuration: "إعدادات Codex...", model: "النموذج", reasoning: "التفكير", execution: "التنفيذ", sandbox: "منطقة التفويض", confirmation: "التأكيد", askContext: "اطلب السياق من Codex", myProfile: "ملفي الشخصي", changePicture: "تغيير صورتي...", defaultPicture: "الصورة الافتراضية", typing: "يكتب...", thinking: "Thinking...", send: "إرسال", search: "بحث", stop: "إيقاف" },
