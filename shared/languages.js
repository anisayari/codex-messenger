...
const appCopy = {
  ...
  en: {
    ...
    chat: { conversation: "Conversation", contactInfo: "Contact info", renameSession: "Rename session...", openProject: "Open project", sessionPrefix: "Session", configuration: "Codex configuration...", model: "Model", reasoning: "Reasoning", execution: "Execution", sandbox: "Authorization zone", confirmation: "Confirmation", askContext: "Ask Codex for context", myProfile: "My profile", changePicture: "Change my picture...", defaultPicture: "Default picture", typing: "is typing...", send: "Send", search: "Search", stop: "Stop" },
    toolbar: { invite: "Invite", files: "Send Files", video: "Video", voice: "Voice", stop: "Stop", activities: "Activities", games: "Games" }
  },
  es: {
    ...
    chat: { conversation: "Conversación", contactInfo: "Información del contacto", renameSession: "Renombrar sesión...", openProject: "Abrir proyecto", sessionPrefix: "Sesión", configuration: "Configuración Codex...", model: "Modelo", reasoning: "Razonamiento", execution: "Ejecución", sandbox: "Zona de autorización", confirmation: "Confirmación", askContext: "Pedir contexto a Codex", myProfile: "Mi perfil", changePicture: "Cambiar mi imagen...", defaultPicture: "Imagen predeterminada", typing: "está escribiendo...", send: "Enviar", search: "Buscar", stop: "Detener" },
