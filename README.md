...
- macOS `v0.0.2.3`: `CodexMessenger-mac-arm64.dmg`.
- Windows `v0.0.2.3`: `CodexMessenger.exe`.
...
- `Codex Messenger Setup 0.0.2-3.exe`: Windows installer.
- `Codex Messenger 0.0.2-3.exe`: portable build.
...
- `Codex-Messenger-0.0.2-3-arm64.dmg` or `Codex-Messenger-0.0.2-3-x64.dmg`.
- `Codex-Messenger-0.0.2-3-arm64.zip` or `Codex-Messenger-0.0.2-3-x64.zip`.
...
- macOS `v0.0.2.3`: `downloads/CodexMessenger-mac-arm64.dmg`.
- Windows `v0.0.2.3`: `downloads/CodexMessenger.exe`.
