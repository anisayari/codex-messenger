...
- macOS `v0.0.2.2`: `CodexMessenger-mac-arm64.dmg`.
- Windows `v0.0.2.2`: `CodexMessenger.exe`.
...
- `Codex Messenger Setup 0.0.2-2.exe`: Windows installer.
- `Codex Messenger 0.0.2-2.exe`: portable build.
...
- `Codex-Messenger-0.0.2-2-arm64.dmg` or `Codex-Messenger-0.0.2-2-x64.dmg`.
- `Codex-Messenger-0.0.2-2-arm64.zip` or `Codex-Messenger-0.0.2-2-x64.zip`.
...
- macOS `v0.0.2.2`: `downloads/CodexMessenger-mac-arm64.dmg`.
- Windows `v0.0.2.2`: `downloads/CodexMessenger.exe`.
